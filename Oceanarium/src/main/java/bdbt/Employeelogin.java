...
public class Employeelogin {
	...
	public Employeelogin(int nr_pracownika, String imie, String nazwisko, String data_urodzenia, String pesel,
	...
	public String toString() {
		return "Employeelogin [nr_pracownika=" + nr_pracownika + ", imie=" + imie + ", nazwisko=" + nazwisko
